...
module.exports = (userAccountService, listService, itemService, shareService, roleService, notificationService,paymentService) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await itemService.dao.db.query("CREATE TABLE item(id SERIAL PRIMARY KEY, label TEXT NOT NULL, quantity INTEGER NOT NULL, checked BOOLEAN, fk_id_list INTEGER)")
