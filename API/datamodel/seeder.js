...
module.exports = (userAccountService, listService, itemService, shareService) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            await shareService.dao.db.query("CREATE TABLE share(fk_id_list INTEGER, useraccount_id INTEGER, state INTEGER, PRIMARY KEY (fk_id_list, useraccount_id), FOREIGN KEY (fk_id_list) REFERENCES list(id), FOREIGN KEY (useraccount_id) REFERENCES useraccount(id))")
            // INSERTs
        } catch (e) {
